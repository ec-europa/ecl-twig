...
class HTMLMarkup extends React.Component {
  ...
  componentDidMount() {
    ...
    channel.on('ecl/jsCode/add_code', this.onAddHTMLMarkup);
  ...
  componentWillUnmount() {
    ...
    channel.removeListener('ecl/jsCode/add_code', this.onAddHTMLMarkup);
  }
...
addons.register('ecl/jsCode', api => {
  // Also need to set a unique name to the panel.
  addons.addPanel('ecl/jsCode/panel', {
    title: 'HTML by JS',
    // eslint-disable-next-line react/prop-types
    render: ({ active }) => (
