...
const formatFooterG1 = dataG1 => {
  ...
  if (dataG1[1][0] && dataG1[1][0].title) {
    dataG1[1][0].title = text(
      'sections[1][0].title',
      dataG1[1][0].title,
      optionalGroupId
    );
  }
  if (dataG1[1][0] && dataG1[1][0].links) {
    dataG1[1][0].links.forEach((link, index) => {
      dataG1[1][0].links[index].link.label = text(
        `sections[[1][0].links[${index}].link.label`,
        dataG1[1][0].links[index].link.label,
        optionalGroupId
      );
      dataG1[1][0].links[index].link.path = text(
        `sections[1][0].links[${index}].link.path`,
        dataG1[1][0].links[index].link.path,
        optionalGroupId
      );
      if (dataG1[1][0].links[index].icon) {
        dataG1[1][0].links[index].icon.name = text(
          `sections[1][1].links[${index}].icon.name`,
          dataG1[1][0].links[index].icon.name,
          optionalGroupId
        );
        dataG1[1][0].links[index].icon.path = text(
          `sections[1][0].links[${index}].icon.path`,
          defaultSprite,
          optionalGroupId
        );
        dataG1[1][0].links[index].icon.size = text(
          `sections[1][1].links[${index}].icon.size`,
          dataG1[1][0].links[index].icon.size,
          optionalGroupId
        );
      }
    });
  }
  if (dataG1[1][1] && dataG1[1][1].title) {
    dataG1[1][1].title = text(
      'sections[1][1].title',
      dataG1[1][1].title,
      optionalGroupId
    );
    dataG1[1][1].title_class_name = text(
      'sections[1][1].title_class_name',
      dataG1[1][1].title_class_name,
      optionalGroupId
    );
  }
  if (dataG1[1][1] && dataG1[1][1].list_class_name) {
    dataG1[1][1].list_class_name = text(
      'sections[1][1].list_class_name',
      dataG1[1][1].list_class_name,
      optionalGroupId
    );
  }
  if (dataG1[1][1] && dataG1[1][1].links) {
    dataG1[1][1].links.forEach((link, index) => {
      dataG1[1][1].links[index].link.label = text(
        `sections[1][1].links[${index}].link.label`,
        dataG1[1][1].links[index].link.label,
        optionalGroupId
      );
      dataG1[1][1].links[index].link.path = text(
        `sections[1][1].links[${index}].link.path`,
        dataG1[1][1].links[index].link.path,
        optionalGroupId
      );
      if (dataG1[1][1].links[index].icon) {
        dataG1[1][1].links[index].icon.name = text(
          `sections[1][1].links[${index}].icon.name`,
          dataG1[1][1].links[index].icon.name,
          optionalGroupId
        );
        dataG1[1][1].links[index].icon.path = text(
          `sections[1][1].links[${index}].icon.path`,
          defaultSprite,
          optionalGroupId
        );
        dataG1[1][1].links[index].icon.size = text(
          `sections[1][1].links[${index}].icon.size`,
          dataG1[1][1].links[index].icon.size,
          optionalGroupId
        );
      }
    });
  ...
  // About.
  if (dataG1[2] && dataG1[2][0].title) {
    dataG1[2][0].title = text(
      'sections[2][0].title',
      dataG1[2][0].title,
      optionalGroupId
    );
    dataG1[2][0].title_class_name = text(
      'sections[2][0].title_class_name',
      dataG1[2][0].title_class_name,
      optionalGroupId
    );
  }
  if (dataG1[2] && dataG1[2][0].links) {
    dataG1[2][0].links.forEach((link, index) => {
      dataG1[2][0].links[index].link.label = text(
        `sections[2][0].links[${index}].link.label`,
        dataG1[2][0].links[index].link.label,
        optionalGroupId
      );
      dataG1[2][0].links[index].link.path = text(
        `sections[2][0].links[${index}].link.path`,
        dataG1[2][0].links[index].link.path,
        optionalGroupId
      );
      if (dataG1[2][0].links[index].icon) {
        dataG1[2][0].links[index].icon.name = text(
          `sections[2][0].links[${index}].icon.name`,
          dataG1[2][0].links[index].icon.name,
          optionalGroupId
        );
        dataG1[2][0].links[index].icon.path = text(
          `sections[2][0].links[${index}].icon.path`,
          defaultSprite,
          optionalGroupId
        );
        dataG1[2][0].links[index].icon.size = text(
          `sections[2][0].links[${index}].icon.size`,
          dataG1[2][0].links[index].icon.size,
          optionalGroupId
        );
      }
    });
  ...
  // Related.
  if (dataG1[2][1] && dataG1[2][1].title) {
    dataG1[2][1].title = text(
      'sections[2][1].title',
      dataG1[2][1].title,
      optionalGroupId
    );
    dataG1[2][1].title_class_name = text(
      'sections[2][1].title_class_name',
      dataG1[2][1].title_class_name,
      optionalGroupId
    );
  }
  if (dataG1[2][1] && dataG1[2][1].links) {
    dataG1[2][1].links.forEach((link, index) => {
      dataG1[2][1].links[index].link.label = text(
        `sections[2][1].links[${index}].link.label`,
        dataG1[2][1].links[index].link.label,
        optionalGroupId
      );
      dataG1[2][1].links[index].link.path = text(
        `sections[2][1].links[${index}].link.path`,
        dataG1[2][1].links[index].link.path,
        optionalGroupId
      );
      if (dataG1[2][1].links[index].icon) {
        dataG1[2][1].links[index].icon.name = text(
          `sections[2][1].links[${index}].icon.name`,
          dataG1[2][1].links[index].icon.name,
          optionalGroupId
        );
        dataG1[2][1].links[index].icon.path = text(
          `sections[2][1].links[${index}].icon.path`,
          defaultSprite,
          optionalGroupId
        );
        dataG1[2][1].links[index].icon.size = text(
          `sections[2][1].links[${index}].icon.size`,
          dataG1[2][1].links[index].icon.size,
          optionalGroupId
        );
      }
    });
